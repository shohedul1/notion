...
import { PiBookOpenText, PiFileThin, PiSparkleLight, PiTargetLight } from "react-icons/pi";
                        ...
                        <div className="flex">
                            <ul className="grid p-2 md:w-[400px] lg:w-[250px] hover:cursor-pointer border-r">
                                <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                                    <PiBookOpenText className="text-2xl mr-2 text-red-600" />
                                    <div>
                                        <a>Wikis</a>
                                ...
                                <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                                    <PiTargetLight className="text-2xl mr-2 text-yellow-600" />
                                    <div>
                                        <a>Projects</a>
                                ...
                                <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                                    <PiFileThin className="text-2xl mr-2 text-blue-600" />
                                    <div>
                                        <a>Docs</a>
                                        <p className="text-gray-400 text-sm font-light">Simple & Powerfull</p>
                                    </div>
                                </div>
                                <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                                    <PiSparkleLight className="text-2xl mr-2 text-purple-600" />
                                    <div>
                                        <a>Shohidul Assistant</a>
                                ...
                                <ul className="grid p-2 md:w-[400px] lg:w-[250px] hover:cursor-pointer border-r">
                                    ...
                                    <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                                        <div>
                                            ...
                                            <p className="text-gray-400 text-sm font-light">See how teams use shohidul</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-1 hover:bg-gray-400/10 p-1 rounded-sm">
                                        <div>
                                            <a>Connections</a>
                                            <p className="text-gray-400 text-sm font-light">Connect your tools to shohidul</p>
                                        </div>
                                    </div>
